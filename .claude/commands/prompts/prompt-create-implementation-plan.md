---
description: User-invocable prompt to create a dependency-ordered implementation plan from approved architecture and design review documents. Call with /prompts/prompt-create-implementation-plan.
allowed-tools:
  - Read
  - Write
  - Edit
...
- `docs/impl-plan.md` with ordered tasks per the `/skills/skill-implementation-planning` format.
