---
description: User-invocable prompt to create or update architecture.md from approved requirements. Call with /prompts/prompt-design-architecture.
allowed-tools:
  - Read
  - Write
  - Edit
...
5. Write `docs/architecture.md` following the structure in the `/skills/skill-architecture-design` skill.
