---
description: User-invocable prompt to run all tests and documentation quality checks to produce verification evidence for the PR gate. Call with /prompts/prompt-verify-release.
allowed-tools:
  - Read
  - Write
  - Edit
