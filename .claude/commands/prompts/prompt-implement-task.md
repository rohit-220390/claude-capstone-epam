---
description: User-invocable prompt to implement one approved task from the implementation plan with tests. Provide the task ID. Call with /prompts/prompt-implement-task.
allowed-tools:
  - Read
  - Write
  - Edit
