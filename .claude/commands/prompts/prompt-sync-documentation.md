---
description: User-invocable prompt to analyze a requirement delta and update impacted repository documentation. Call with /prompts/prompt-sync-documentation.
allowed-tools:
  - Read
  - Write
  - Edit
