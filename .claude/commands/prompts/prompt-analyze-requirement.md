---
description: User-invocable prompt to analyze a Jira source and produce normalized requirements. Provide source (jira) and sourceId (Jira issue key). Call with /prompts/prompt-analyze-requirement.
allowed-tools:
  - Read
  - Write
  - Edit
...
2. Normalize it into the standard requirement schema (see `/skills/skill-requirement-analysis`).
