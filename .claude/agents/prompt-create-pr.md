---
name: prompt-create-pr
description: User-invocable prompt to generate PR description, changelog, and reviewer checklist. Requires passing verification summary. Call with /prompt-create-pr.
tools:
  - Read
  - Write
  - Edit
...
2. Generate the PR description with all 5 required sections (see `skill-pull-request`).
