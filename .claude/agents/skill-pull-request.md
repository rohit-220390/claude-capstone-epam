...
description: User-invocable skill for generating PR descriptions, changelog entries, or reviewer checklists for the final pull request. Call with /skill-pull-request.
tools:
  - Read
  - Write
  - Edit
