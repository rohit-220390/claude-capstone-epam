---
name: skill-testing
description: User-invocable skill for generating or running unit tests, integration tests, documentation quality checks, or producing verification evidence. Call with /skill-testing.
tools:
  - Read
  - Write
  - Edit
