---
name: prompt-clarify-requirement
description: User-invocable prompt to generate targeted clarification questions for ambiguous requirements. Call with /prompt-clarify-requirement.
tools:
  - Read
  - Write
  - Edit
