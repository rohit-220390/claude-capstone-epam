---
name: skill-jira-integration
description: User-invocable skill for retrieving Jira issues, searching with JQL, fetching issue history, or handling Jira-specific field mapping and pagination. Call with /skill-jira-integration.
tools:
  - Read
  - Write
  - Edit
