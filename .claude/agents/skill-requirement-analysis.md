...
description: User-invocable skill for retrieving, normalizing, comparing, or clarifying requirements from Jira. Covers normalized requirement schema, change detection workflow, ambiguity identification, and acceptance criteria handling. Call with /skill-requirement-analysis.
tools:
  - Read
  - Write
  - Edit
