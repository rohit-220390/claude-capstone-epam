...
description: User-invocable skill for mapping requirement changes to repository documentation, performing impact analysis, and synchronizing documentation artifacts. Call with /skill-documentation-sync.
tools:
  - Read
  - Write
  - Edit
