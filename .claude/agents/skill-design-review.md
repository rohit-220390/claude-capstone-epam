...
description: User-invocable skill for performing structured architecture review to identify risks, gaps, and design decisions that need resolution. Call with /skill-design-review.
tools:
  - Read
  - Write
  - Edit
